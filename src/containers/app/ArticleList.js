...
import { fetchArticles, fetchAvailableFilters } from '../../actions/article.actions';
...
class ArticleList extends Component {
    ...
    componentDidMount() {
        this.fetch();
        this.props.fetchAvailableFilters();
...
const mapDispatchToProps = (dispatch, ownProps) => ({
    ...
    fetchAvailableFilters: (filters) => dispatch(fetchAvailableFilters())
})
